...
% dir0 ='M:\Stanford\2020-12-15 Ca2+ activity data issues\Demo data for T-half rising and decay, half-height width\';
% addpath(dir0)
...
elseif strcmp(cellType, 'SBC2')
    sbc2_Analysis(sigsToMeasure,rawSigsToMeasure,tvals,cellIDsToMeasure,approxStart,approxEnd,viewPlots,saveFlag,saveDir);
...
elseif strcmp(cellType, 'SBC1')
    sbc1_Analysis(sigsToMeasure,rawSigsToMeasure,tvals,cellIDsToMeasure,approxStart,approxEnd,viewPlots,saveFlag,saveDir);
else
